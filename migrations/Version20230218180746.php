 ...
 */
final class Version20230218180746 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE transporteur (id INT AUTO_INCREMENT NOT NULL, company_id INT DEFAULT NULL, nom VARCHAR(255) NOT NULL, vehicule_description LONGTEXT NOT NULL, numero INT NOT NULL, prix_standard DOUBLE PRECISION NOT NULL, image VARCHAR(255) NOT NULL, INDEX IDX_A2564975979B1AD6 (company_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE transporteur ADD CONSTRAINT FK_A2564975979B1AD6 FOREIGN KEY (company_id) REFERENCES company (id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE transporteur DROP FOREIGN KEY FK_A2564975979B1AD6');
