...
/**
     ...
     */
    public function order_By_Nom2(Request $request,SponsorRepository $SponsorRepository): Response
    {
//list of students order By Nom
        $Sponsor = $SponsorRepository->orderByNomS();

        return $this->render('Sponsor/back.html.twig', [
            'Sponsor' => $Sponsor,
        ]);
